...
class Setting_Ui(QWidget):  # noqa: N801
    def __init__(self, persepolis_setting: QSettings) -> None:
        ...
        self.wait_label.setToolTip(
            QCoreApplication.translate(
                'setting_ui_tr',
                '<html><head/><body><p>Set the seconds to wait between retries. Download manager will  retry  downloads  when  the  HTTP  server  returns  a  503 response.</p></body></html>', # noqa: E501
            ),
        )
        ...
        aria2_path_tooltip = QCoreApplication.translate(
            'setting_ui_tr',
            "<html><head/><body><p>Attention: Wrong path may cause problems!\
